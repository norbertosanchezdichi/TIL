...
plt.plot(np.arange(0, Y_test_length + 1), np.append([0], np.cumsum(classifier_CAP)), c = 'k', linewidth = 2, label = 'Random Forest Classifier')
...
plt.legend()
plt.savefig('Random_Forest_Classification_Cumulative_Accuracy_Profile_(CAP).png')
plt.clf()
